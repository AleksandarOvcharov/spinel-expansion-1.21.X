...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.RAW_SPINEL_BLOCK);

        addDrop(ModBlocks.SPINEL_ORE, oreDrops(ModBlocks.SPINEL_ORE, ModItems.RAW_SPINEL));
        addDrop(ModBlocks.SPINEL_DEEPSLATE_ORE, multipleOreDrops(ModBlocks.SPINEL_DEEPSLATE_ORE, ModItems.RAW_SPINEL, 3, 7));
        addDrop(ModBlocks.ANTHRACITE_ORE, multipleOreDrops(ModBlocks.ANTHRACITE_ORE, ModItems.RAW_ANTHRACITE, 2, 5));
